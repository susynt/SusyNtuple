...
{
    if(signalQuality){
        if     (m_eleID == eleID::MediumLLH)        return electron->mediumLLH;
        else if(m_eleID == eleID::TightLLH)         return electron->tightLLH;
        else if(m_eleID == eleID::MediumLLH_nod0)   return electron->mediumLLH_nod0;
        else if(m_eleID == eleID::TightLLH_nod0)    return electron->tightLLH_nod0;
        else {
